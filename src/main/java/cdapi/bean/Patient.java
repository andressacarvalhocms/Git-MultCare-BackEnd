...
public class Patient {
	...
	/**
	 * Retorna a afiliaçao racial do paciente. (Informações sobre raça e etnia podem
	 * ser usado para ajudar a avaliar o risco de um paciente em relação a condições
	 * particulares. Em alguns locais (por exemplo, os EUA), essas informações
	 * também podem ser usadas operacionalmente para detectar disparidades étnicas
	 * na forma como os pacientes são tratados. Em outros, transmissão desta
	 * informação em um registro médico é proibido.)
	 *
	...
	/**
	 * Inserir a afiliaçao racial do paciente. (Informações sobre raça e etnia podem
	 * ser usado para ajudar a avaliar o risco de um paciente em relação a condições
	 * particulares. Em alguns locais (por exemplo, os EUA), essas informações
	 * também podem ser usadas operacionalmente para detectar disparidades étnicas
	 * na forma como os pacientes são tratados. Em outros, transmissão desta
	...
	/**
	 * Retorna o grupo etnico do paciente. (Informações sobre raça e etnia podem ser
	 * usado para ajudar a avaliar o risco de um paciente em relação a condições
	 * particulares. Em alguns locais (por exemplo, os EUA), essas informações
	 * também podem ser usadas operacionalmente para detectar disparidades étnicas
	 * na forma como os pacientes são tratados. Em outros, transmissão desta
	 * informação em um registro médico é proibido.)
	...
	/**
	 * Inserir o grupo etnico do paciente. (Informações sobre raça e etnia podem ser
	 * usado para ajudar a avaliar o risco de um paciente em relação a condições
	 * particulares. Em alguns locais (por exemplo, os EUA), essas informações
	 * também podem ser usadas operacionalmente para detectar disparidades étnicas
	 * na forma como os pacientes são tratados. Em outros, transmissão desta
	...
	/**
	 * Retorna o local de nascimento do paciente. (O local de nascimento do paciente
	 * é registrado como uma associação de papéis entre a classe de naturalidade. A
	 * classe de associação do local de nascimento liga a classe do paciente a
	 * classe de lugar.)
	 *
	 ...
	 * naturalidade. A classe de associação do local de nascimento liga a classe do
	 * paciente a classe de lugar.)
	 *
	 * @param birthPlace
