...
public class SintomasEspecialista {
	...
	private String batCardiacosAlt;
...
public SintomasEspecialista(QuestionarioTriagem questionarioTriagem) {
	...
	this.batCardiacosAlt = setValorBooleano(questionarioTriagem.possuiSintomaPorDescricao("taquicardia"));
